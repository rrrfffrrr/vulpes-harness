...
- `openspec/schemas/requirements/`, `openspec/schemas/gdd/`, `openspec/schemas/architecture/`, `openspec/schemas/backend/`, `openspec/schemas/frontend/`, `openspec/schemas/game-ui/`
...
- `.claude/commands/opsx/require.md`, `gdd.md`, `architect.md`, `backend.md`, `frontend.md`, `game-ui.md`  (Claude)
- `.codex/skills/opsx-require/`, `opsx-gdd/`, `opsx-architect/`, `opsx-backend/`, `opsx-frontend/`, `opsx-game-ui/`  (Codex)
...
```bash
openspec schemas                 # lists requirements, gdd, architecture, backend, frontend, game-ui
...
Run the workflows: `/opsx:require` -> `/opsx:gdd` or `/opsx:architect` -> `/opsx:backend` / `/opsx:frontend` / `/opsx:game-ui` -> `/opsx:propose`.
