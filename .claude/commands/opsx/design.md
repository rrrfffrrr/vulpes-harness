...
- crosscutting-concepts.md (arc42 §8 — security, compliance, logging, …)
...
- **architecture-overview** — arc42 §1,3,4 + the ISO/IEC 42010 stakeholder↔concern↔view map. This map is how each role finds its reading list; it lives ONLY here.
...
- **crosscutting-concepts** — arc42 §8. Map compliance concepts to planning goals/obstacles by id.
