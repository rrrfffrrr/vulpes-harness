...
- flows/index.md (domain index) + flows/\<domain\>.md (navigation map, event->transition tables, API call sequences, statecharts for complex interactions)
